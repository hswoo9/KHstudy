...
<body>
	...
	<a href="${ contextPath }/views/actiontag/standard/forward.jsp">jsp:include</a>
	...
	<p>
		문자열 처리에 관한 메소드들을 EL 구문으로 사용할 수 있게 하는 라이브러리이다.
	</p>
	
	<a href="${ contextPath }/views/actiontag/jstl/function.jsp">JSTL Formatting</a>
