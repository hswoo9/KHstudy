...
@WebServlet(name = "board/FileDown", urlPatterns = { "/board/fileDown" })
public class BoardFileDownServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BufferedInputStream bis = new BufferedInputStream(new FileInputStream(downFile)); // 보조스트림은 단독으로 실행 불가
