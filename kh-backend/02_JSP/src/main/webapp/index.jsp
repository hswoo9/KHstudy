...
<body>
	...
	<ol>
		...
		<ul>
			...
			<li>isErrorPage : 현재 JSP 페이지가 예외를 처리하는 페이지라는걸 지정한다.</li>
		</ul>
	...
	<h2>4. JSP 내장 객체</h2>
	<p>
		JSP 파일이 자바 코드로 생성될 때 자동으로 추라되는 객체들을 내장 객체라고 한다. <br>
...
<!--  		Arrays.stream(cookies).forEach(cookie -> System.out.println(cookie.getValue())); -->
	...
	<p>
		...
		해당 객체들은 유효한 범위 안에서 필요한 데이터를 서로 공유할 수 있고 이 공유되는 데이터를 속성(Attribute)라고 한다.
	</p>
